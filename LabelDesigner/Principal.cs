...
namespace LabelDesigner
{
    public class Principal
    {
        ...
        internal void ExportZpl()
        {
            try
            {
                if (SelectedLabel != null)
                {
                    ...
                    ILabelAssembler zpla = new ZplAssembler();

                    var zpl = zpla.AssembleLabel(SelectedLabel);
        ...
        internal void OpenImageEditor(Artifact t)
        {
            ...
            if (result == DialogResult.OK)
            {
                t.Element.Size.Height = im.Edicao.Height;
                t.Element.Size.Width = im.Edicao.Width;
                t.Element.Rectangles = im.Edicao.Rectangles;

                t.Element.Image = new CompressedImage() { CompressedData = im.Edicao.CompressedContent };
