...
{
    public partial class RenderedTextFieldEditor : Form
    {
        ...
        public void UpdateElementData()
        {
            ...
            _Field.SetEditedFont(fdFonte.SelectedFont);
        ...
        private void Popula()
        {
            if(_Field != null)
            {
                ...
                fdFonte.SelectedFont     = _Field.GetEditedFont();
        ...
        public RenderedTextFieldEditor(LabelElement field)
        {
            InitializeComponent();
