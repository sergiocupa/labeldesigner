    ...
    public partial class EditorImagem : Form
    {
        ...
        private Bitmap Render(bool OnOpen)
        {
            if (!string.IsNullOrEmpty(Imagem_Caminho))
            {
                ...
                Edicao = ZplImageAssembler.ImageToZplField(Imagem_Caminho, w, h, Rotate, ID, false, Proporcao, Threshold);
                Edicao.ImageName = Imagem_Arquivo;
