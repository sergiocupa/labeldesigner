...
namespace Label.Renderers.Qrcode
{
    internal static class MatrixUtil
    {
        ...
        public static void buildMatrix(Base.BitArray dataBits, ErrorCorrectionLevel ecLevel, Version version, int maskPattern,
           ByteMatrix matrix)
        {
            clearMatrix(matrix);
        ...
        public static void maybeEmbedVersionInfo(Version version, ByteMatrix matrix)
        {
            ...
            Base.BitArray versionInfoBits = new Base.BitArray();
        ...
        public static void embedDataBits(Base.BitArray dataBits, int maskPattern, ByteMatrix matrix)
        {
            int bitIndex = 0;
            int direction = -1;
        ...
        {
            if (!QRCodeData.isValidMaskPattern(maskPattern))
            {
